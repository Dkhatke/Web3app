...
contract Crowdfunding {
    ...
    struct Backer{
        ...
        mapping(uint256 =>bool) fundedTiers ; //to keep track of who funded which amt
    ...
    constructor(
        ...
        owner = _owner; // wallet that deploys contract becomes owner
    ...
    // Fund the campaign by selecting a tier
    ...
    // Withdraw funds after goal is reached (only owner)
    function withdraw() public onlyOwner {
       checkAndUpdateCampaignState();
       require(state == CampaignState.Successful ,"  Campaign not suuccesful yet");
